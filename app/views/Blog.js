...
export class Blog extends React.Component {
    ...
    componentDidMount() {
        return fetch('https://public-api.wordpress.com/rest/v1.1/sites/nativetutorial2.wordpress.com/posts')
...
export class BlogItem extends React.Component {
    ...
    render() {
        let blogItems = `
        <a href=${this.props.id} style="textDecorationLine: none; collor: #000000; textAlign: center">
